...
import type { CSSEntries, CSSEntry } from "../types.d.ts";
...
export const parseColor = (value: string): ParsedColor | null => {
  ...
  if (namedColor) return { mode: "rgb", color: namedColor, alpha: undefined };
...
const namedColors: Record<string, [string, string, string] | undefined> = {
